...
export default function AddAddressScreen() {
  ...
  const onSubmit = (data: AddressFormData) => {
    Alert.alert("Xác nhận", "Bạn có chắc muốn thêm địa chỉ này?", [
          ...
          >
            <TouchableOpacity
              ...
              style={{
                ...
                shadowOpacity: createAddressMutation.isPending ? 0 : 0.3,
                shadowRadius: 8,
                elevation: createAddressMutation.isPending ? 0 : 6,
              }}
              activeOpacity={0.8}
            >
